      ...
      <div className="mx-auto container relative z-0 px-4 xl:px-0">
        <div className="flex flex-col-reverse md:flex-row">
          <div data-aos="fade-up" data-aos-duration="1500" className="md:w-3/5 md:pt-24 pb-10 lg:py-32 xl:py-48">
            <h1 className="text-3xl lg:text-6xl 2xl:text-8xl font-black text-gray-900 text-center md:text-left tracking-tighter f-f-i md:w-7/12 leading-tight  text-skin-base uppercase">Let's<span className=" text-red-500"> grow </span>your businness with the <span className=" text-red-500">rights talents</span></h1>
            ...
            <div className="w-full pt-10 flex justify-center md:block">
              <button className="hover:opacity-90 transition
                      duration-500
                     linear
                      transform hover:scale-110 py-3 px-10 lg:py-11 lg:px-2 rounded-full  text-black text-sm md:text-lg  shadow-3xl" style={{
                background: "linear-gradient(145deg,#feffff, #d5dadc)",
                 boxShadow:"10px 10px 20px #c9cecf -10px -10px 20px #ffffff"}} ><span className="">Learn More</span>  </button>
          </div>
        </div>
