...
//         <section className="text-gray-100 h-full flex flex-col  w-11/12 mx-auto  body-font relative -bottom-36 rounded-lg">
//           <div className="w-full    ">
//             <div className="w-full  absolute mt-5 justify-between py-40 mx-auto flex mdx:flex-col mdx:mt-0 mdx:py-0 ">
             
//               <div className="flex  w-full mdx:justify-center md:w-1/2 items-center justify-between md:flex">
//                 <div className="md:pl-32 md:pr-12 text-center mdx:text-left">
//                   <div className="space-y-6 text-center text-skin-base md:text-left">
//                     <div className="space-y-4 undefined max-w-24">
//                       <h6 className="font-medium text-lg m-0">Realiable & Verified</h6>
//                       <h2 className="font-semibold text-4xl m-0 tracking-tight md:text-4xl xl:text-5xl">Anticip is an online staffing company.</h2>
//                       <div className="u-p2">
//                         <p className="">We love working with agile companies to find them the best talent to maintain their growth
//                           They are people searching for others, anticip find the right talents fitting with each company culture</p>
//                       </div>
//                     </div>
//                     <a className="text-link  border-solid border-b-4 inline-block font-medium pb-1 ease-in-out" href="/">How it works</a>
//                   </div>
//                 </div>
//               </div>

//               {/* <div className="lg:w-1/2 md:w-1/2  bg-skin-darkblue rounded-lg p-10 opacity-100  flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative  shadow-md">
//                 <h2 className="text-gray-900 text-lg mb-1 font-medium title-font"> </h2>
//                 <p className="leading-relaxed mb-5 text-gray-100">Send us a message</p>
...
//                 <p className="text-xs text-gray-100 mt-3">All rights reserved.</p>
//               </div> */}
            
            
//             <div className=" mx-auto py-24 w-1/2 h-full rounded-lg">
//               <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2519.0280708639266!2d4.366769915344224!3d50.84916445239805!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c3c37db91b7c3b%3A0x8290c19cda89389b!2sRue%20de%20la%20Presse%204%2C%201000%20Bruxelles!5e0!3m2!1sfr!2sbe!4v1642001964525!5m2!1sfr!2sbe" width="100%" height="100%" style={{border:"0", allowFullScreen:"" ,loading:"lazy"}}>
//               </iframe>
//             </div>
...
//            */}
//        <section>
//                <div className="lg:w-1/2 md:w-1/2  bg-skin-darkblue rounded-lg p-10 opacity-100  flex flex-col md:ml-auto w-full mt-40 md:mt-0 relative  shadow-md">
//                   <h2 className="text-gray-900 text-lg mb-1 font-medium title-font"> </h2>
//                   <p className="leading-relaxed mb-5 text-gray-100">Send us a message</p>
//                   <div className="relative mb-4">
//                     <label for="email" className="leading-7 text-sm text-gray-100">Email</label>
